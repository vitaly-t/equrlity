    ...
    */
    ...
    formatTime: function (seconds, guide) {
      ...
      let secs = Math.floor(seconds % 60),
        ...
        gmins = Math.floor(guide / 60 % 60),
        ghrs = Math.floor(guide / 3600),
        msecs = Math.floor((seconds - secs) * 1000);
      let s = secs.toString(),
        m = mins.toString(),
        h = hrs.toString(),
        gm = gmins.toString(),
...
export function register(player, options: any) {
